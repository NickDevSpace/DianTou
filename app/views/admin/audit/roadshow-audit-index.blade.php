...
<form action="{{{action('AdminAuditController@getRoadshowAudit')}}}" method="get" class="am-form am-form-inline" role="form">
    <div class="am-g">
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                          <div class="am-btn-group am-btn-group-xs">
                            <button class="admin-op-btn am-btn am-btn-default am-btn-xs am-text-danger" data-url="{{{action('AdminAuditController@getRoadshowAuditDetail', array($r->id))}}}" data-target="_self">
