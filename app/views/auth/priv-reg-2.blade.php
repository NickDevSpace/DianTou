        ...
        <div class="am-u-sm-10 am-u-lg-8 am-u-md-8 am-u-sm-centered">
            <div style="height:50px;">
                <ul class="dt-step dt-step-3">
                    <li>1.创建账户</li>
                    <li class="active">2.填写身份信息</li>
                    <li>3.成功</li>
                </ul>
            </div>

            <form action="{{{action('AuthController@postSavePrivAcct')}}}" method="post" class="am-form am-form-horizontal" style="margin-top:50px;">
                ...
                <div class="am-form-group">
                    <label for="i-account" class="am-u-sm-3 am-form-label">昵称：</label>
                    <div class="am-u-sm-6 am-u-end">
                        <input type="text" id="i-nickname" name="nickname" placeholder="给自己取个昵称吧" data-validate-message="请填写昵称" >
                    </div>
                </div>
                <div class="am-form-group">
                ...
                <div class="am-form-group">
                    <label for="i-city-code" class="am-u-sm-3 am-form-label">居住城市：</label>
                    <div class="am-u-sm-2">
